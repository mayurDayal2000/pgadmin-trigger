...
CREATE OR REPLACE FUNCTION public.auto_apply_audit_trigger()
...
BEGIN
    FOR obj IN SELECT * FROM pg_event_trigger_ddl_commands() WHERE command_tag = 'CREATE TABLE' LOOP
        ...
        IF obj.schema_name = 'public' AND obj.object_identity != 'public.audit_logger' THEN
            EXECUTE format(
...
EXECUTE FUNCTION public.auto_apply_audit_trigger();