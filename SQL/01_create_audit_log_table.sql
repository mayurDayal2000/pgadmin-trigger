...
CREATE OR REPLACE FUNCTION public.jsonb_diff_vals(old_data JSONB, new_data JSONB)
RETURNS JSONB AS $$
DECLARE
    result JSONB := '{}'::jsonb;
    entry RECORD;
...
DROP TABLE IF EXISTS public.audit_logger;
CREATE TABLE public.audit_logger (
